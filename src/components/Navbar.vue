    ...
    <div class="nav-wrapper">
      ...
      <div class="nav-content" v-else>
        <div class="link-wrapper">
            ...
            <div class="link-item">
              <div class="ps-re">
                <svg
                  ...
                  stroke="black"
                  xmlns="http://www.w3.org/2000/svg"
                  :class="{ activeStrokeSvg: currentPathName === 'user-home' }"
                >
                  <path
                    d="M22.58 6.34986L12.475 0.896855C12.178 0.736855 11.821 0.736855 11.525 0.896855L1.42502 6.34986C0.939018 6.61386 0.758018 7.21986 1.02002 7.70586C1.20002 8.04086 1.54502 8.23086 1.90002 8.23086C2.06002 8.23086 2.22402 8.19286 2.37502 8.11086L3.10902 7.71486L4.69902 18.9649C4.91502 20.1789 6.00902 21.0269 7.35902 21.0269H16.641C17.991 21.0269 19.085 20.1789 19.303 18.9389L20.891 7.71386L21.628 8.11186C22.113 8.37486 22.72 8.19386 22.982 7.70786C23.245 7.22186 23.062 6.61486 22.578 6.35286L22.58 6.34986ZM12 14.4349C10.205 14.4349 8.75002 12.9799 8.75002 11.1849C8.75002 9.38986 10.205 7.93486 12 7.93486C13.795 7.93486 15.25 9.38986 15.25 11.1849C15.25 12.9799 13.795 14.4349 12 14.4349Z"
                  />
          ...
          <router-link class="route-link" to="/user/notification">
            <div class="link-item">
              <div class="ps-re">
                <svg
                  v-if="currentPathName === 'user-notification'"
                  width="20"
                  height="22"
                  viewBox="0 0 20 22"
                  fill="#FF6600"
          ...
          <router-link class="route-link" to="/user/public/chat">
            <div class="link-item">
              <div class="ps-re">
                <svg
                ...
                >
                  <path
                    d="M9.55 9.082C9.823 9.264 10.177 9.264 10.45 9.082L20 2.716V2.5C20 1.26 18.99 0.25 17.75 0.25H2.25C1.01 0.25 0 1.26 0 2.5V2.697L9.55 9.082Z"
                    fill="#FF6600"
                  />
                  <path
                    d="M11.26 10.295C10.877 10.55 10.44 10.677 10 10.677C9.56 10.677 9.123 10.55 8.74 10.294L0 4.45203V16.122C0 17.362 1.01 18.372 2.25 18.372H17.75C18.99 18.372 20 17.362 20 16.122V4.47003L11.26 10.293V10.295Z"
                  />
                </svg>
                <svg
                  v-else
                  ...
                  fill="black"
                  xmlns="http://www.w3.org/2000/svg"
                  :class="{ activeSvg: currentPathName === 'user-public-chat' }"
                >
                  <path
                    d="M17.25 0H2.75C1.233 0 0 1.234 0 2.752V15.247C0 16.765 1.233 18 2.75 18H17.25C18.767 18 20 16.765 20 15.247V2.752C20 1.234 18.767 0 17.25 0ZM2.75 1.5H17.25C17.94 1.5 18.5 2.06 18.5 2.75V3.464L10.45 8.831C10.177 9.011 9.824 9.013 9.55 8.829L1.5 3.464V2.75C1.5 2.06 2.06 1.5 2.75 1.5ZM17.25 16.498H2.75C2.06 16.498 1.5 15.938 1.5 15.248V5.222L8.74 10.052C9.123 10.308 9.562 10.436 10 10.436C10.44 10.436 10.877 10.308 11.26 10.053L18.5 5.223V15.245C18.5 15.935 17.94 16.495 17.25 16.495V16.498Z"
                  />
                </svg>
                <div
                  :class="{ 'd-none': !isNotification }"
          ...
          <router-link class="route-link" to="/user/private/message">
            <div class="link-item">
              <div class="ps-re">
                <svg
                  v-if="currentPathName === 'user-private-message'"
                  width="20"
                  height="19"
                  viewBox="0 0 20 19"
                  fill="#FF6600"
